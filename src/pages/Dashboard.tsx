...
import { Activity, Heart, Brain, Zap, Moon, Droplets, TrendingUp } from "lucide-react";
      ...
      <div className="grid lg:grid-cols-2 gap-6">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }}
          ...
          <div className="mt-6 grid grid-cols-3 gap-4 text-center">
            {[{ label: "Sleep", val: "7.2h" }, { label: "Skin Health", val: "82%" }, { label: "Recovery", val: "Good" }].map(m => (
              <div key={m.label}>
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }}
          ...
          <div className="flex items-center justify-between mb-6">
            ...
            <div className="flex items-center gap-1 text-glow-success text-sm"><TrendingUp className="w-4 h-4" /> +12%</div>
          </div>
